...
<body>
    <div class="container invoice my-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                <div><span class="biller-info">Invoice#:</span> <?= $registration_number ?></div>
            </div>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <img src="./assets/img/payment-qrcode.jpg" alt="" width="100px">
            </div>
            <div class="col-md-6 col-sm-6">
                <button class="btn btn-success" onclick="payWithCard()">Pay with Card</button>
