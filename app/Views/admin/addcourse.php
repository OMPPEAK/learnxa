...
<title>Add Course | LearnXa</title>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Topic</label>
                        ...
                        <div class="col-12">
                            <label for="inputEmail4" class="form-label">Course Title</label>
                        ...
                        <div class="col-md-4">
                            <label for="inputAddress" class="form-label">Preview Course Video ID</label>
                            <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St">
                        </div>
                        <div class="col-md-4">
